...
! function(t, e, i) {
  L.MarkerClusterGroup = L.FeatureGroup.extend({
      ...
      _bindEvents: function() {
        ...
        (e || n) && this.on("clusterdblclick", this._zoomOrSpiderfy, this), i && (this.on("clustermouseover", this._showCoverage, this), this.on("clustermouseout", this._hideCoverage, this), t.on("zoomend", this._hideCoverage, this))
      },
      ...
      _unbindEvents: function() {
        var t = this.options.spiderfyOnMaxZoom,
          ...
          n = this._map;
        (t || i) && this.off("clusterdblclick", this._zoomOrSpiderfy, this), e && (this.off("clustermouseover", this._showCoverage, this), this.off("clustermouseout", this._hideCoverage, this), n.off("zoomend", this._hideCoverage, this))
      },
      _zoomEnd: function() {
